...
public:
    ...
    // static void queryBenchmarkTD(vector<vector<TDEdge>> adjacencyList, vector<vector<TCHQueryEdge>> adjacencyListCH, int nbRuns) {
    //     bool correct = true;
    //     float eps = 0.002;
    ...
    //         DijkstraTD dijkstra(adjacencyList, s, t);
    //         CHQuery dijkstraCH(adjacencyListCH, s, t);
