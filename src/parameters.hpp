...
#define PATH_BENCHMARKS                             "./benchmarks2/"
...
#define PARAMS_EXP_NB                               2                       // 1 : single modal, 2 : static multi-modal, 3 : time-dependent 
...
#define PARAMS_PREPROCESSING_BENCHMARK              false
